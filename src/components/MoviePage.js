               ...
               <div className="playposter">
                   ...
                   <Modal ref="modal" backdropStyle={{backgroundColor: '#193240'}} modalStyle={{width: "90%", height: "90%"}}>
                       <div className="videocontainer">
                           <iframe style={{height: "90vh", border: "none", zIndex: 3000}} src={`https://vodlocker.to/embed?i=${movie.title}&poster=0&chromecast=0&trailer=0`} width="100%"></iframe>
                       </div>
                       <a className="fullscreenbutton button" href={`https://vodlocker.to/embed?i=${movie.title}&poster=0&chromecast=0&trailer=0`}> Enter Fullscreen</a>
                   </Modal>
               </div>
